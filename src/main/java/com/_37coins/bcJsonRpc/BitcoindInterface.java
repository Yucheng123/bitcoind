...
public interface BitcoindInterface {
	...
	public List<Searchlogs> searchlogs(long beginBlockHeight, long endBlockHeight,Map<String,ArrayList<String>> addresss);
	public List<UnspentResult> listunspent(Integer start,Integer end,ArrayList<String> stringArrayList);
	public boolean importaddress(String address,String account,Boolean isrescan);
	//stop
	public String gethexaddress(String addr);
	public String fromhexaddress(String addr);
	public ContractResult callcontract (String contractAddr,String decode);
	public SendToContractResult sendtocontract (String contractAddr,String queryString,BigInteger var2,BigInteger gasLimit,String gasPrice,String toAddress );
	public String stop();
	public String createrawtransaction(ArrayList<Map<String,Object>> unspent,Map<String,BigDecimal> addressAmountPairs );
	public RawTransaction getrawtransaction(String txhash,Integer isDecode);
	public String getrawtransaction(String txhash);
	public List<String> omni_listblocktransactions(long blockHeight);
	public OmiTransaction omni_gettransaction(String txid);
	public OmniBalance omni_getbalance(String address,Integer propertyId);
	//构造交易
	public String omni_createpayload_simplesend(Integer propertyid, String amount);
	public String omni_createrawtx_opreturn(String rawTransactionHash,String payload);
	public String omni_createrawtx_reference(String opreturn,String to);
	public String omni_createrawtx_change(String reference,ArrayList<Map<String,Object>> unspent,String changeAddr,BigDecimal fee);
	public Signresult signrawtransaction(String hexValue);
	public Signresult signrawtransaction(String hexValue,ArrayList<Map<String,Object>> unspent,ArrayList<String> privateKeys);
	public String sendrawtransaction(String signedHex);
	public SmartFee estimatesmartfee (Integer block);
